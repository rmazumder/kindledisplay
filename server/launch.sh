...
convert -depth 8 -rotate 0 weather-processed.svg weather-processed.png
...
rm /var/www/html/weather-script-output.png
mv weather-script-output.png /var/www/html/weather-script-output.png
